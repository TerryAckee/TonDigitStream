...
In this segment I -       [properly identified adjusted the AI generated program script's properties
to take the curve out the coordinates program path of my variable by editing those functions in the script]
but
